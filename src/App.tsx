...
import { Shield, Users, Star, Trophy, ChevronDown, BookOpen, Target, Zap, Play, Check, Award, ArrowRight, ArrowUpRight, TrendingUp, LineChart, Wallet, BookMarked, BarChart3, BrainCircuit, Menu, X, Sparkles, MessageCircle, Bot, Gem } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 group">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-300"></div>
              ...
              <div className="relative">
                <span className="text-xl font-bold bg-gradient-to-r from-white via-blue-400 to-blue-600 bg-clip-text text-transparent animate-gradient">
                  Coin
                </span>
                <span className="text-xl font-bold bg-gradient-to-r from-blue-400 via-white to-blue-600 bg-clip-text text-transparent animate-gradient ml-1">
                  Skill
                </span>
                <div className="absolute -top-1 -right-2">
                  <Gem className="w-3 h-3 text-blue-400 animate-pulse" />
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8">
              ...
              <span className="text-sm text-blue-400">Ведущая школа криптотрейдинга</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4">
              ...
              <span className="text-sm text-blue-400">Доступные тарифы</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4">
              ...
              <span className="text-sm text-blue-400">Учебный план</span>
            </div>
